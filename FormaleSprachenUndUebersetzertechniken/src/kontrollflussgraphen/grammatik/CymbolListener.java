...
public interface CymbolListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CymbolParser#varDeclExtern}.
	 * @param ctx the parse tree
	 */
	void enterVarDeclExtern(CymbolParser.VarDeclExternContext ctx);
	/**
	 * Exit a parse tree produced by {@link CymbolParser#varDeclExtern}.
	 * @param ctx the parse tree
	 */
	void exitVarDeclExtern(CymbolParser.VarDeclExternContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CymbolParser#normalstat}.
	 * @param ctx the parse tree
	 */
	void enterNormalstat(CymbolParser.NormalstatContext ctx);
	/**
	 * Exit a parse tree produced by {@link CymbolParser#normalstat}.
	 * @param ctx the parse tree
	 */
	void exitNormalstat(CymbolParser.NormalstatContext ctx);
	/**
