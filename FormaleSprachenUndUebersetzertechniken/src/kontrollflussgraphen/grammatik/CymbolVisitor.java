...
public interface CymbolVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CymbolParser#varDeclExtern}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarDeclExtern(CymbolParser.VarDeclExternContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CymbolParser#normalstat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNormalstat(CymbolParser.NormalstatContext ctx);
	/**
